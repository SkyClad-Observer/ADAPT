...
if __name__ == '__main__':
    create_dirs('/home/minghai/data/LLMproof/ADT-Lemma-Discovery/lemma_discovery/proof_fixpoint_hammer_fails_cp/Verifybankersq2consistentLazy.v/bankersq2consistent_Lazy9/test.json')
